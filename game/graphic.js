function init()
{
    ...
    ennemy1 = new Ennemy("ennemy1", 0xff0000, new THREE.Vector2(100, 100), 0);
    ...
    for (x = minX; x <= maxX; x = x+sizeOfTileX){
        for (y = minY; y <= maxY; y = y+sizeOfTileY){
            ...
            if (x == 0 && y == 0)
            {
                ...
                new THREE.MeshLambertMaterial({color: 0xf0fff0 , transparent: true, opacity: 0.6}));
...
{
    pointLight = new THREE.PointLight(color, 50, 0, 350);
